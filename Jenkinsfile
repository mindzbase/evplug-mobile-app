                ...
                script {
                    ...
                    sh '''echo "Deleting Existing Evplug Mobile Server Container"
                        ...
                        then
                            ...
                            echo ""
                            echo ""
                            docker run -d --name ${DOCKER_CONTAINER_NAME} -p 14080:80 -p 14876:8765 -p 14880:8080 /home/mindzbase/evplug_config/mobile/mobile_env:/.env /home/mindzbase/evplug_config/mobile/evplug-prod.json:/evplug-prod.json /home/mindzbase/evplug_config/mobile/wheelsdrive-config.json:/wheelsdrive-config.json --restart always dcr.mindzbase.tech/${DOCKER_IMAGE}:1.0.${BUILD_NUMBER}
